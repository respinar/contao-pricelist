...
$GLOBALS['TL_LANG']['tl_pricelist']['groups']      = array('Allowed member groups', 'These groups will be able to see items in this list.');
 ...
 * Buttons
 */
$GLOBALS['TL_LANG']['tl_pricelist']['new']    = array('New List', 'Create a new List');
$GLOBALS['TL_LANG']['tl_pricelist']['show']   = array('List details', 'Show the details of List ID %s');
$GLOBALS['TL_LANG']['tl_pricelist']['edit']   = array('Edit List', 'Edit List ID %s');
$GLOBALS['TL_LANG']['tl_pricelist']['copy']   = array('Duplicate List', 'Duplicate List ID %s');
$GLOBALS['TL_LANG']['tl_pricelist']['delete'] = array('Delete List', 'Delete List ID %s');
